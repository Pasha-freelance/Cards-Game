...
statisticsWins.textContent = `Количесво побед : ${winsCounter}`;
statisticsAttempts.textContent = `Количество ходов ${string}: ${attemptsCounter}`;
statisticsGuessed.textContent = `Количество угаданных карточек : ${guessedCounter} из ${cards.length}`;
